...
async def get_desktop_by_id(db: AsyncSession, desktop_id: UUID) -> models.Desktop | None:
...
async def get_desktop_by_authid(db: AsyncSession, desktop_authid: str) -> models.Desktop | None:
...
async def get_desktop_by_realm(db: AsyncSession, realm: str) -> models.Desktop | None:
