...
Revision ID: ff926b82a6d2
Revises:
Create Date: 2026-01-26 19:34:22.589922
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum("guest", "user", name="user_role"), nullable=False),
